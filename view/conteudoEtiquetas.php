  <div class="container">
    <div class="row justify-content-center align-middle p-5">
      <div class="col-6 text-center">
        <h3>Gerar Planilha para Postagem (PPN)</h3>
        <form method="POST" action="conferir_caixa.php" enctype="multipart/form-data">
          <div class="mb-3 text-center">
          <input type="number" id="numero_caixa" class="form-control" aria-describedby="CaixaHelpBlock" min="45000" max="51200" autofocus required>
